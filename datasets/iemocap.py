...
class Iemocap(Dataset):
    def __init__(self,annotations_file, audio_dir,  transform=None ):
        ...
        values = ["Other","Fear","Surprise","Disgust","Neutral state"]


        self.audio_labels = self.audio_labels[~self.audio_labels["emotion"].isin(values)]
        self.replace = {
    ...
    def __getitem__(self, idx):
        ...
        return wave, self.replace[label]
